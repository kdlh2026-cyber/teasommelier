...
<%@ include file="../../header.jsp" %>
	<div class="cb-detail-page">
		<div class="cb-detail-title-row">
			<h2 class="cb-detail-title">에디토리얼</h2>
			<span class="cb-detail-subtitle">에디토리얼입니다.</span>
		</div>
		...
		<div class="cb-detail-actions">
			...
			<sec:authorize access="hasRole('ADMIN')">
				<a class="cb-edit-btn" href="/admin/community/cb_editorialUpdateForm?cb_no=${viewCBdao.cb_no}">수정</a>
